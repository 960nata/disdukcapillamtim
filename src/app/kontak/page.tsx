    ...
    <div className="min-h-screen bg-white flex flex-col font-sans">
      ...
      <main className="flex-grow pb-20">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Contact Cards Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 -mt-10 relative z-20">
            ...
            <a href="https://wa.me/628123456789" target="_blank" rel="noopener noreferrer" 
              ...
              <div className="w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">WhatsApp</h3>
              <p className="text-gray-600 text-sm mb-4">Chat pelayanan cepat dan responsif.</p>
              <span className="text-[#25D366] font-bold text-sm">Hubungi Sekarang →</span>
            </a>

            {/* Instagram */}
            <a href="https://instagram.com/disdukcapillamtim" target="_blank" rel="noopener noreferrer" 
               className="bg-white border border-gray-100 rounded-2xl p-8 flex flex-col items-center text-center shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
              <div className="w-16 h-16 bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] rounded-full flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Instagram</h3>
              <p className="text-gray-600 text-sm mb-4">Ikuti dokumentasi dan info terbaru.</p>
              <span className="text-[#ee2a7b] font-bold text-sm">Ikuti Kami →</span>
            </a>

            {/* TikTok */}
            <a href="https://tiktok.com/@disdukcapillamtim" target="_blank" rel="noopener noreferrer" 
               className="bg-white border border-gray-100 rounded-2xl p-8 flex flex-col items-center text-center shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
              <div className="w-16 h-16 bg-[#000000] rounded-full flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform">
              ...
              <p className="text-gray-600 text-sm mb-4">Edukasi dan konten kreatif pelayanan.</p>
              <span className="text-[#000000] font-bold text-sm">Tonton Video →</span>
            </a>
            ...
            <a href="mailto:disdukcapil@lampungtimurkab.go.id" target="_blank" rel="noopener noreferrer" 
              ...
              <p className="text-gray-600 text-sm mb-4">Kirim surat dan pengaduan resmi.</p>
              <span className="text-[#00529C] font-bold text-sm">Kirim Email →</span>
            </a>
