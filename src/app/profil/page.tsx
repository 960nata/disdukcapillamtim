        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          >
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="flex-1 flex flex-col gap-6">
                <div className="bg-white border border-gray-100 p-4 md:p-8 rounded-2xl md:rounded-[2rem] flex-1 shadow-md hover:shadow-lg transition-shadow">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={idx} className="flex gap-4">
                        ...
                        <p className="text-xs md:text-base text-gray-700 font-medium">{misi}</p>
                      </div>
                    ))}
                  </div>
                </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Kedudukan */}
              <div className="bg-white border border-gray-100 p-4 md:p-10 rounded-2xl md:rounded-[2rem] flex flex-col shadow-md hover:shadow-lg transition-shadow">
                <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center text-[#27ae60] font-bold text-xl mb-6">
                  01
                </div>
                <h3 className="text-base md:text-2xl font-bold text-gray-900 mb-4">Kedudukan</h3>
              ...
              {/* Tugas Pokok */}
              <div className="bg-[#0b2b26] p-4 md:p-10 rounded-2xl md:rounded-[2rem] flex flex-col text-white shadow-xl transform md:-translate-y-4 transition-transform">
                <div className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center text-[#27ae60] font-bold text-xl mb-6">
                  02
                </div>
                <h3 className="text-base md:text-2xl font-bold text-white mb-4">Tugas Pokok</h3>
                <p className="text-xs md:text-base text-white/80 font-medium leading-relaxed">
              ...
              <div className="bg-white border border-gray-100 p-4 md:p-10 rounded-2xl md:rounded-[2rem] flex flex-col shadow-md hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-base md:text-2xl font-bold text-gray-900 mb-4">Fungsi</h3>
                <p className="text-xs md:text-base text-gray-600 font-medium leading-relaxed">
            ...
            <div className="mt-6 bg-white border border-gray-100 p-4 md:p-12 rounded-2xl md:rounded-[2rem] shadow-md">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                {[
                  ...
                  <div key={idx} className="flex gap-4 items-start">
                    ...
                    <p className="text-xs md:text-base text-gray-700 font-medium leading-relaxed pt-1">{fungsi}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Tujuan & Sasaran */}
              <div className="bg-[#0b2b26] p-4 md:p-10 rounded-2xl md:rounded-[2rem] text-white shadow-xl">
              ...
              <div className="flex flex-col gap-6">
                <div className="bg-white border border-gray-100 p-4 md:p-10 rounded-2xl md:rounded-[2rem] flex-1 shadow-md hover:shadow-lg transition-shadow">
          ...
          >
            ...
            {structure.filter(p => p.order === 1 || p.role.includes("Kepala")).map((person, i) => (
              <div key={i} className="bg-white border border-gray-100 rounded-2xl md:rounded-[2rem] p-4 md:p-8 mb-6 flex flex-col md:flex-row items-center gap-8 shadow-md hover:shadow-lg transition-all duration-300">
                <div className="w-24 h-24 md:w-32 md:h-32 bg-[#27ae60]/10 rounded-full flex items-center justify-center border-2 border-[#27ae60]/20 flex-shrink-0">
                  {person.photoUrl ? (
                    <Image src={person.photoUrl} alt={person.name} width={128} height={128} className="rounded-full object-cover" />
                  ) : (
                    <span className="text-3xl md:text-5xl font-bold text-[#27ae60]">{person.name.charAt(0)}</span>
                  )}
                </div>
                <div className="text-center md:text-left">
                  <h3 className="text-base md:text-3xl font-bold text-gray-900 mb-2">{person.name}</h3>
                  <p className="text-sm md:text-xl font-medium text-[#27ae60] mb-4">{person.role}</p>
                  {person.nip && (
            ...
            <div className="relative">
              <div className="flex gap-4 overflow-x-auto pb-6 snap-x [&::-webkit-scrollbar]:hidden [ms-overflow-style:none] [scrollbar-width:none]">
                {structure.filter(p => !(p.order === 1 || p.role.includes("Kepala"))).map((person, i) => (
                  <div key={i} className="min-w-[240px] md:min-w-[300px] bg-white border border-gray-100 rounded-2xl p-4 flex flex-col relative overflow-hidden snap-align-start shadow-sm hover:shadow-md transition-shadow group">
                    <div className="w-12 h-12 bg-gray-50 rounded-full flex items-center justify-center text-gray-700 font-bold text-lg mb-4 shadow-sm border border-gray-100">
                      {person.photoUrl ? (
