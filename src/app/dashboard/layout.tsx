...
export default function DashboardLayout({
  ...
  const menuItems = [
    ...
    { name: 'Manajemen Statistik', href: '/dashboard/statistics', icon: 'M18 20V10 M12 20V4 M6 20v-6', id: 'statistics' },
    { name: 'Manajemen Grafik', href: '/dashboard/charts', icon: 'M18 20V10 M12 20V4 M6 20v-6', id: 'charts_mgmt' },
