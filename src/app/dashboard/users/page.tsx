...
const AVAILABLE_PERMISSIONS = [
  ...
  { id: 'chats', name: 'Percakapan AI', icon: 'M8 10h.01M12 10h.01M16 10h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z' },
  { id: 'announcements', name: 'Manajemen Pengumuman', icon: 'M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z M12 9v4 M12 17h.01' },
  { id: 'notifications', name: 'Kirim Notifikasi', icon: 'M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9 M13.73 21a2 2 0 0 1-3.46 0' },
  { id: 'demographics', name: 'Manajemen Demografi', icon: 'M18 20V10 M12 20V4 M6 20v-6' },
