    ...
    <div className="p-[14px] md:p-8 space-y-6 font-sans min-h-screen bg-gray-50/50">
      ...
      <div className="bg-white p-[10px] md:p-5 rounded-2xl border border-gray-100 shadow-sm flex flex-col md:flex-row gap-4 items-center justify-between">
        <div className="relative w-full md:w-96">
          ...
          />
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="absolute left-4 top-3.5 text-gray-400"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
        </div>
        ...
        <div className="flex gap-3 w-full md:w-auto">
          <select 
            ...
            className="text-sm font-bold text-gray-600 bg-gray-50 border border-gray-100 rounded-xl px-4 py-3 focus:outline-none focus:border-[#27ae60] focus:bg-white transition-all w-full md:w-44 appearance-none"
                  ...
                  <tr key={item.id} className="hover:bg-gray-50/50 transition-colors group">
                    <td className="px-6 py-5">
                      <div className="flex flex-col gap-1 max-w-md">
                        <span className="font-bold text-gray-900 group-hover:text-[#27ae60] transition-colors line-clamp-2">{item.title}</span>
                        <span className="text-[11px] text-gray-400 font-medium uppercase tracking-tight">ID: #{item.id}</span>
                      </div>
                    </td>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-[2px] flex items-center justify-center z-[100] p-4">
          <div className="bg-white rounded-3xl max-w-sm w-full p-8 shadow-2xl space-y-6">
            <div className="flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-red-50 rounded-2xl flex items-center justify-center text-red-500 mb-4 rotate-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>
              </div>
              <h3 className="text-xl font-black text-gray-900">Hapus Artikel?</h3>
              <p className="text-sm text-gray-500 mt-2 font-medium">Berita yang dihapus tidak dapat dikembalikan lagi. Anda yakin?</p>
            </div>
            
            <div className="flex flex-col gap-3">
              <button 
                onClick={executeDelete}
                className="w-full py-4 text-sm font-black text-white bg-red-500 rounded-2xl hover:bg-red-600 transition-all shadow-lg shadow-red-100"
              >
                Ya, Hapus Sekarang
              </button>
              <button 
