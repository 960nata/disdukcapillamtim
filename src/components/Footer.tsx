      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="col-span-1 md:col-span-4">
            <div className="flex items-center gap-2 font-bold transition-colors text-white mb-4">
              ...
              <div className="flex flex-col leading-tight">
                ...
                <span className="text-[10px] font-medium text-white/60">LAMPUNG TIMUR</span>
              </div>
            </div>
          ...
          <div className="col-span-1 md:col-span-3">
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              <li className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#27ae60]"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
                +62 812-3456-7890
              </li>
              <li className="flex items-center gap-2">
              ...
              <li className="flex items-start gap-2">
                ...
                Jl. Ahmad Yani No. 1, Sukadana, Lampung Timur
              </li>
            </ul>
          </div>
          ...
          <div className="col-span-1 md:col-span-3">
            ...
            <div className="rounded-xl overflow-hidden h-[150px] border border-white/10">
              <iframe 
                src="https://maps.google.com/maps?q=Disdukcapil%20Lampung%20Timur&t=&z=13&ie=UTF8&iwloc=&output=embed" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
          <div>
            &copy; {new Date().getFullYear()} Disdukcapil Lampung Timur. All rights reserved.
          </div>
